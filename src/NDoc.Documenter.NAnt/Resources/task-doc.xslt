    ...
    <xsl:template match="class">
        ...
        <xsl:if test="string-length(string($attr)) != 0">
            <head>
                ...
                <title>&lt;<xsl:value-of select="attribute[@name = 'NAnt.Core.Attributes.TaskNameAttribute']/property[@name = 'Name']/@value" />&gt; Task</title>
            </head>
            <body>
                <table width="100%" border="0" cellspacing="0" cellpadding="2" class="NavBar">
                    <tr>
                        <td class="NavBar-Cell" width="100%">
                            ...
                            &lt;<xsl:value-of select="attribute[@name = 'NAnt.Core.Attributes.TaskNameAttribute']/property[@name = 'Name']/@value" />&gt; Task
                        </td>
                    </tr>
                </table>
