...
namespace NAnt.Core.Functions {
    ...
    public class AssemblyFunctions : FunctionSetBase {
        ...
        /// <param name="failOnError"><see cref="bool" /> indicating whether extracting the attribute should halt on first error.</param>
        ...
        public static string GetAttributeProperty(Assembly assembly, string attributeAssemblyPath, string attributeTypeName, string propertyName) {
            Assembly attributeAssembly = attributeAssembly = Assembly.LoadFile(attributeAssemblyPath);
