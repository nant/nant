...
namespace NAnt.VSNet {
    ...
    /// </summary>
    internal class EverettSolution : SolutionBase {
        public EverettSolution(string solutionContent, SolutionTask solutionTask, TempFileCollection tfc, GacCache gacCache, ReferencesResolver refResolver) : base(solutionTask, tfc, gacCache, refResolver) {
