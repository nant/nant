...
namespace NAnt.VSNet {
    ...
    /// </summary>
    internal class RainierSolution : SolutionBase {
        public RainierSolution(string solutionContent, SolutionTask solutionTask, TempFileCollection tfc, GacCache gacCache, ReferencesResolver refResolver) : base(solutionTask, tfc, gacCache, refResolver) {
