    ...
    public class CopyTest : BuildTestBase 
    {
        ...
        const string _xmlProjectTemplate2 = @"
            <project>
                ...
                <copy verbose='true' todir='{0}/destination' failonerror='true'>
                    <fileset basedir='{0}'>
        ...
        public void Test_Copy_Only_Directory()
        {
            ...
            results = RunBuild(String.Format(CultureInfo.InvariantCulture, _xmlProjectTemplate, dest, tempDir1));
        ...
        /// <summary>
        /// Copy everything from under tempDir1 to a new temp directory and ensure it exists.
        /// </summary>
        [Test]
        ...
        public void Test_Copy_Structure_Directories() {
            string results = RunBuild(String.Format(CultureInfo.InvariantCulture, _xmlProjectTemplate2, tempDir1 ));
