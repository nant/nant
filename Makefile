...
linux-bootstrap-nant.dotnet:
	$(MCS) -target:library -define:MONO -debug -o bin/NAnt.DotNetTasks.dll -r:bin/NAnt.Core.dll -r:bin/lib/mono/1.0/log4net.dll -r:bin/lib/mono/1.0/NDoc.Core.dll -recurse:src/NAnt.DotNet/*.cs src/CommonAssemblyInfo.cs
